...
import { Core as ContractClass } from "./Core";
import { core as ProtoNamespace } from "./proto/core";
  ...
  switch (contractArgs.entry_point) {
    ...
    case 0x6d0c5abf: {
      const args = Protobuf.decode<ProtoNamespace.get_reserves_arguments>(
        contractArgs.args,
        ProtoNamespace.get_reserves_arguments.decode
      );
      const res = c.get_reserves(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.get_reserves_result.encode);
      break;
    }
    ...
    case 0xda47c2f4: {
      const args = Protobuf.decode<ProtoNamespace.swap_arguments>(
        contractArgs.args,
        ProtoNamespace.swap_arguments.decode
      );
      const res = c.swap(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_object.encode);
      break;
    }

    case 0x769a27d2: {
      const args = Protobuf.decode<ProtoNamespace.skim_arguments>(
        contractArgs.args,
        ProtoNamespace.skim_arguments.decode
      );
      const res = c.skim(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_object.encode);
      break;
    }

    case 0x75c75efe: {
      const args = Protobuf.decode<ProtoNamespace.sync_arguments>(
        contractArgs.args,
        ProtoNamespace.sync_arguments.decode
      );
      const res = c.sync(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_object.encode);
      break;
    }
